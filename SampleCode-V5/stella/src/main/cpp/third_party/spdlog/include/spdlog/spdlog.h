...
// Implementation of synchronous_factory::create
// It is placed here because it requires details::registry to be defined
template<typename Sink, typename... SinkArgs>
inline std::shared_ptr<spdlog::logger> synchronous_factory::create(std::string logger_name, SinkArgs &&... args)
{
