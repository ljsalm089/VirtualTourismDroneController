...
if (TARGET SuiteSparse::CXSparse)
  message("Found SuiteSparse::CXSparse")
  set(CSPARSE_FOUND TRUE)
  set(CSPARSE_INCLUDE_DIR "") # Not needed if using target
  set(CSPARSE_LIBRARY SuiteSparse::CXSparse)
  set(CSparse_FOUND TRUE)
  return()
endif()

if (CSparse_FOUND OR CSPARSE_FOUND)
  return()
endif()

message("this log shows the attention of finding csparse library")
